 ...
 *
 * @param campaigns - Campaign ids.
 * @returns Implied product ids.
 */
export function impliedProductsForCampaigns(campaigns: string[]): Set<string> {
 ...
 *
 * @param branches - Scaffold branch names.
 * @returns Implied product ids.
 */
export function impliedProductsForScaffolds(branches: string[]): Set<string> {
  const products = new Set<string>();
