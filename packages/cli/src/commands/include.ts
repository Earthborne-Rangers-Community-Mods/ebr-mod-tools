...
import type { ProgressEvent, Registry } from "core/types.js";
...
async function includeAction(sourcesArg: string[] | string | undefined) {
 ...
 */
function handleIncludeError(err: unknown) {
...
function printMultiSummary(completed: string[], failedAt: string, remaining: string[]) {
  console.error("\n--- Summary ---");
